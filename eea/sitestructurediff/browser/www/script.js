$(function () {
	...
	Panel.jsTree.init($("#tree-panel .tree"),
	       { data : { type : "json", 
			  async : true, 
                          url : "@@sitemap-data",
			  async_data : function (NODE) { return { path : $(NODE).attr("path") || 0 } } },
	...
	StatusPanel.create	= function () { StatusPanel.jsTree.create(false, (StatusPanel.jsTree.container.find("li").size() == 0 ? -1 : false) ); }
